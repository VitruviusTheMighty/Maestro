...
try:
    ...
    try:
        ...
        from flocking.world import World
        from flocking.steering_ball import SteeringBall
        from flocking.button import Button
    except:
        from games.flocking.vector import Vector
        from games.flocking.moving_ball_2d import MovingBall
        from games.flocking.world import World
        from games.flocking.steering_ball import SteeringBall
        from games.flocking.button import Button
...
class FlockingGame:
    ...
    def __init__(self, screen=None,w=1024, h=768):
        self.w = w
        self.h = h
    ...
    def run_game(self, numAgents=10):
        """
        ...
        # width = 1024
        # height = 768
        if not self.SCREEN: my_win = pygame.display.set_mode((self.w,self.h))
        else: my_win = self.SCREEN
